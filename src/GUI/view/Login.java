...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(username !=null && !username.isEmpty() && password!=null && !pass.isEmpty()){
            if(accountBLL.getAccountByUsername(username)!=null){
                account a = accountBLL.getAccountByUsername(username);
                if(a.getPassword().equals(pass)){
                    new MainFrame(a.getUsername()).setVisible(true);
                        this.dispose();
                }else{
            ...
            JOptionPane.showMessageDialog(null, "Trường username và password không thể để trống.");
        }
